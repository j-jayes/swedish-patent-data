...
Including terms "Elektriker" and "Metallslipare".
...
# P2: Who did this work and with which skills?

<html><div style='float:left'></div><hr color='#EB811B' size=1px width=796px></html>

---
# Who did this work and with which skills?

### Did some regions which specialized in electricity related production draw workers with required skills from further afield?

---
# Who did this work?

### Birthplaces of Linköping residents in 1910

```{r, out.width="70%"}
knitr::include_graphics("slides/migration_p3.PNG")
```

Source: 1910 Swedish Census form IPUMS International
