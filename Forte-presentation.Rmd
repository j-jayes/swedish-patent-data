...
g <- df %>% 
  ...
  labs(caption = "Source: Edvinsson, R. Number of employees in eight types of activities in Sweden 1850-2000\nVia Historia.se",
       fill = NULL,
...
```{r}
knitr::include_graphics("slides/agric_manu_output.PNG")
```
